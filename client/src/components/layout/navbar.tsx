                ...
                <div className={cn(
                    ...
                    <Link href="/" className="relative z-50 group">
                        <div className="flex items-center gap-3">
                            <span className="text-xl font-bold font-['Outfit'] tracking-wider text-white">Taiki Mishima</span>
                        </div>
                    </Link>
                    ...
                    <div className="hidden md:flex items-center gap-8">
                        {navItems.map((item) => (
                            <button
                                ...
                                className={cn(
                                    "text-sm font-bold tracking-widest uppercase font-['Outfit'] transition-colors py-4",
                    ...
                    <div className="hidden md:flex items-center gap-6">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 text-xs font-bold tracking-widest text-white/50 hover:text-white transition-colors font-['Outfit'] py-2"
                        >
                        ...
                        <Button
                            ...
                            size="sm"
                            className="rounded-full h-9 px-5 text-xs font-bold tracking-widest bg-[#f6bd2b] text-[#040B17] hover:bg-[#f6bd2b]/90 shadow-[0_0_15px_rgba(246,189,43,0.2)] hover:shadow-[0_0_25px_rgba(246,189,43,0.4)] transition-all"
                        >
                            CONSULT
                        </Button>
                    </div>
                        ...
                        <div className="flex flex-col gap-6 pb-12">
                            {navItems.map((item) => (
                                <button
                                    key={item.path}
                                    onClick={() => handleNavClick(item.path)}
                                    className="text-2xl font-bold text-white font-['Outfit'] block py-2 border-b border-white/5 text-left"
                                >
                                    {item.label}
                                </button>
                            ))}
                            <div className="pt-6 flex flex-col gap-4">
                                <Button
                                    onClick={() => handleNavClick("#contact")}
                                    className="w-full rounded-full h-12 text-sm font-bold tracking-widest bg-[#f6bd2b] text-[#040B17]"
                                >
                                    CONSULT
                                </Button>
