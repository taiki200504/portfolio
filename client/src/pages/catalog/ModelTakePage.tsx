...
export default function ModelTakePage() {
                    ...
                    <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
                        ...
                        >
                            ...
                            <h1 className="text-5xl md:text-7xl font-bold font-['Outfit'] mb-4">
                                {t("catalogPage.models.take.name")}
                            </h1>
                            ...
                            <p className="text-xl text-white/70 mb-8 leading-relaxed max-w-xl">
                                {t("catalogPage.models.take.desc")}
                            </p>
                            <div className="flex flex-wrap gap-4 mb-12">
                                {(t("catalogPage.models.take.features") as string[]).map((feature, i) => (
                            ...
                            <Link href={getLink("/preorder?model=take")}>
                        ...
                        >
                            ...
                            <img
                                src="/assets/products/take/main.png"
                                alt="Model Take"
                    ...
                    <div className="container mx-auto px-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
                            {[1, 2, 3, 4].map((num, i) => (
                                ...
                                >
                                    <img
                                        src={`/assets/products/take/usecase${num}.png`}
                                        alt={`Use Case ${num}`}
                                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                                    />
                                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-8">
                                        <h3 className="text-xl font-bold font-['Outfit'] mb-2">
                                            {t(`catalogPage.models.take.useCases.${i}.title`)}
                                        </h3>
                                        <p className="text-white/70 text-sm">
                                            {t(`catalogPage.models.take.useCases.${i}.desc`)}
                                        </p>
                                    </div>
                                </motion.div>
                            ))}
                    ...
                    <div className="container mx-auto px-4 max-w-4xl">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
                            <div className="flex justify-between border-b border-white/10 pb-4">
                                ...
                                <span className="font-bold">企業オフィス・中堅層</span>
                            </div>
                            <div className="flex justify-between border-b border-white/10 pb-4">
                                <span className="text-white/60">Sound System</span>
                                <span className="font-bold">High-Fidelity Stereo</span>
                            </div>
                            <div className="flex justify-between border-b border-white/10 pb-4">
                                <span className="text-white/60">Lighting</span>
                                <span className="font-bold">Relaxation LED</span>
                            </div>
                            <div className="flex justify-between border-b border-white/10 pb-4">
                                <span className="text-white/60">Material</span>
                                <span className="font-bold">Standard Fabric & Composite</span>
                            </div>
                            <div className="flex justify-between border-b border-white/10 pb-4">
                                <span className="text-white/60">AI Guide</span>
                                <span className="font-bold">Standard Guide</span>
                            </div>
                            <div className="flex justify-between border-b border-white/10 pb-4">
                                <span className="text-white/60">Seat</span>
                                <span className="font-bold">Ergonomic Reclining</span>
                            </div>
                        </div>
                    </div>
                </Section>
