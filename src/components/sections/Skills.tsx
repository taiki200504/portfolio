        ...
        <Section id="skills" className="py-20 bg-white border-t border-black/10">
            <div className="container mx-auto px-4 max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-left">
                    <div>
                        <h3 className="text-lg font-bold text-black mb-6 border-b border-black/20 pb-2 font-['Outfit']">Product</h3>
                    ...
                    <div>
                        <h3 className="text-lg font-bold text-black mb-6 border-b border-black/20 pb-2 font-['Outfit']">Growth</h3>
                        <ul className="list-disc list-inside space-y-3 text-sm text-black/80 font-medium">
                    ...
                    <div>
                        <h3 className="text-lg font-bold text-black mb-6 border-b border-black/20 pb-2 font-['Outfit']">Build</h3>
                        <ul className="list-disc list-inside space-y-3 text-sm text-black/80 font-medium">
